...
public class Steak2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.steak2);
        ...
        favBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if(favBtn.isChecked()){
                    Toast.makeText(Steak2.this, "Item added to Favorite", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Steak2.this, "Item removed from Favorite", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
